...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFudWVscHMiLCJhIjoiY2s4eXJuejBoMDRpaTNmcHJrMTlhN2g2NiJ9.ANKNNlF39d8ENcNQlpDPMA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/manuelps/ck8yt2uoj073l1io40a71d5r6',
    scrollZoom: false //   center: [-118.1, 34.1],
    //   zoom: 6
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Set marker to locations and map
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:8000/api/v1/users/".concat(urlType),
              data: data
            });
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_IgmkgOSfsSiPhmfRbJUwAhHQ00oBhKtzLy'); // 1) Get Checkout Session from endpoint (router)
...
if (updateDataForm) {
  updateDataForm.addEventListener('submit', function (ev) {
    ev.preventDefault();
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              tourId = ev.target.dataset.tourId;
